...
namespace MOP.DebugTools
{
    class DebugMonitor : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (gui != null)
            {
                var hudVal = gui.transform.Find("HUD/FPS/HUDValue");
                if (hudVal != null)
                {
                    GameObject fpsObject = GameObject.Instantiate(hudVal.gameObject);
            ...
            switch (debugPage)
            {
                ...
                case DebugPage.SatsumaInfo:
                    if (satsuma != null)
                    {
                        ...
                        sb.Append("<color=yellow>InspectionArea</color> ").Append(Satsuma.Instance != null ? Satsuma.Instance.IsSatsumaInInspectionArea.ToString() : "False").AppendLine();
                        sb.Append("<color=yellow>ParcFerme</color> ").Append(Satsuma.Instance != null ? Satsuma.Instance.IsSatsumaInParcFerme.ToString() : "False").AppendLine();
                        if (driverHeadPivot != null)
                        {
                    ...
                    {
                        sb.AppendLine("CORRIS not found");
                    }
                    break;
